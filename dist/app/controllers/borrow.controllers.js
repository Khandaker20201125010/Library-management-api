...
exports.borrowRoutes.post("/", (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!foundBook) {
            return (0, errorHandler_1.handleError)(res, 404, "Book not found");
        }
        if (foundBook.copies < quantity) {
            return (0, errorHandler_1.handleError)(res, 400, "Not enough copies available");
        }
...
exports.borrowRoutes.get("/", (_req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        (0, errorHandler_1.handleError)(res, 500, "Failed to retrieve summary", error);
    }
}));
